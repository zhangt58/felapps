...
class DataScanFrame(wx.Frame):
    def __init__(self, parent):
        ...
        self.var1_pv_set_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_pv_set_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer1.Add(self.var1_pv_set_st,
                     wx.GBPosition(0, 0),
        ...
        self.var1_pv_set_tc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_pv_set_tc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.var1_pv_set_tc.SetToolTip(
            u"Input variable data source (set), usually a PV string.")

        gbSizer1.Add(self.var1_pv_set_tc,
                     wx.GBPosition(0, 1),
        ...
        self.var1_pv_read_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_pv_read_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer1.Add(self.var1_pv_read_st,
                     wx.GBPosition(0, 3),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.var1_pv_read_tc = wx.TextCtrl(sbsizer_l.GetStaticBox(), wx.ID_ANY,
                                           ...
                                           wx.DefaultSize, 0)
        self.var1_pv_read_tc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_pv_read_tc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.var1_pv_read_tc.SetToolTip(
            u"Input variable data source (read), usually a PV string.")

        gbSizer1.Add(self.var1_pv_read_tc,
                     wx.GBPosition(0, 4),
                     wx.GBSpan(1, 2),
        ...
        self.var1_pv_flag_ckb = wx.CheckBox(
            ...
            wx.DefaultSize, 0)
        self.var1_pv_flag_ckb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_pv_flag_ckb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer1.Add(self.var1_pv_flag_ckb,
                     wx.GBPosition(0, 6),
        ...
        self.var1_from_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_from_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer1.Add(self.var1_from_st,
                     wx.GBPosition(1, 0),
                     wx.GBSpan(1, 1), wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        self.var1_from_tc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_from_tc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.var1_from_tc.SetToolTip(
            u"Variable varying range start point, a float number.")

        gbSizer1.Add(self.var1_from_tc,
                     wx.GBPosition(1, 1),
                     wx.GBSpan(1, 2),
        ...
        self.var1_to_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_to_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer1.Add(self.var1_to_st,
                     wx.GBPosition(1, 3),
                     wx.GBSpan(1, 1), wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        self.var1_to_tc = wx.TextCtrl(sbsizer_l.GetStaticBox(), wx.ID_ANY,
                                      u"10", wx.DefaultPosition,
                                      wx.DefaultSize, wx.TE_PROCESS_ENTER)
        self.var1_to_tc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_to_tc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.var1_to_tc.SetToolTip(
            u"Variable varying range end point, a float number.")

        gbSizer1.Add(self.var1_to_tc,
                     wx.GBPosition(1, 4),
                     wx.GBSpan(1, 2),
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)

        var1_set_comboxChoices = [u"none", u"user-defined"]
        self.var1_set_combox = wx.ComboBox(
            sbsizer_l.GetStaticBox(), wx.ID_ANY, u"none", wx.DefaultPosition,
            wx.DefaultSize, var1_set_comboxChoices, 0)
        self.var1_set_combox.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var1_set_combox.SetToolTip(
            u"Choose 'user-defined' option to define the SET action, or leave it as 'none'."
        )

        gbSizer1.Add(self.var1_set_combox,
                     wx.GBPosition(1, 6),
                     wx.GBSpan(1, 1),
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
        ...
        self.var2_pv_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var2_pv_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer1.Add(self.var2_pv_st,
                     wx.GBPosition(2, 0),
                     wx.GBSpan(1, 1), wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        self.var2_pv_tc = wx.TextCtrl(sbsizer_l.GetStaticBox(), wx.ID_ANY,
                                      ...
                                      wx.DefaultSize, wx.TE_PROCESS_ENTER)
        self.var2_pv_tc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var2_pv_tc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.var2_pv_tc.SetToolTip(
            u"Input dependent variable data source (read), usually a PV string."
        )

        gbSizer1.Add(self.var2_pv_tc,
                     wx.GBPosition(2, 1),
                     wx.GBSpan(1, 3),
                     wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 5)

        var2_op_comboxChoices = [
            u"none", u"sum", u"max", u"min", u"user-defined"
        ]
        self.var2_op_combox = wx.ComboBox(
            sbsizer_l.GetStaticBox(), wx.ID_ANY, u"none", wx.DefaultPosition,
            wx.DefaultSize, var2_op_comboxChoices, wx.CB_READONLY)
        self.var2_op_combox.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var2_op_combox.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.var2_op_combox.SetToolTip(
            u"Choose functional operation to Var-II.")

        gbSizer1.Add(self.var2_op_combox,
                     wx.GBPosition(2, 4),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.var2_op_st.SetFont(
            wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.var2_op_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer1.Add(self.var2_op_st,
                     wx.GBPosition(2, 5),
        ...
        self.mode_st = wx.StaticText(sbsizer_l.GetStaticBox(), wx.ID_ANY,
                                     ...
                                     wx.DefaultSize, 0)
        self.mode_st.Wrap(-1)
        self.mode_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.mode_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        ...
        self.ds_flag_rb = wx.RadioButton(sbsizer_l.GetStaticBox(), wx.ID_ANY,
                                         ...
                                         wx.DefaultSize, 0)
        self.ds_flag_rb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.ds_flag_rb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.ds_flag_rb.SetToolTip(u"Check to enable parameters scan mode.")
        ...
        self.daq_flag_rb = wx.RadioButton(sbsizer_l.GetStaticBox(), wx.ID_ANY,
                                          ...
                                          wx.DefaultSize, 0)
        self.daq_flag_rb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.daq_flag_rb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.daq_flag_rb.SetToolTip(
        ...
        self.daq_pv_list_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.daq_pv_list_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        bSizer26.Add(self.daq_pv_list_st, 0,
                     wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 30)

        self.daq_pv_list_tc = wx.TextCtrl(sbsizer_l.GetStaticBox(), wx.ID_ANY,
                                          wx.EmptyString, wx.DefaultPosition,
                                          wx.DefaultSize, 0)
        self.daq_pv_list_tc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.daq_pv_list_tc.SetToolTip(u"Input PVs seperated by ';'")

        bSizer26.Add(self.daq_pv_list_tc, 1,
                     wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 5)

        self.daq_pv_list_btn = wx.Button(sbsizer_l.GetStaticBox(), wx.ID_ANY,
                                         u"...", wx.DefaultPosition,
                                         wx.Size(40, -1), 0)
        self.daq_pv_list_btn.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))

        bSizer26.Add(self.daq_pv_list_btn, 0,
        ...
        self.adv_mode_ckb = wx.CheckBox(sbsizer_l.GetStaticBox(), wx.ID_ANY,
                                        ...
                                        wx.DefaultSize, 0)
        self.adv_mode_ckb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.adv_mode_ckb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.adv_mode_ckb.Enable(False)
        self.adv_mode_ckb.SetToolTip(
        ...
        self.iternum_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.iternum_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        ...
        self.iternum_sc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.iternum_sc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.iternum_sc.SetToolTip(u"Total number of scan iteration.")

        fgSizer5.Add(self.iternum_sc, 0,
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
        ...
        self.shotperiter_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.shotperiter_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        ...
        self.shotperiter_sc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.shotperiter_sc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.shotperiter_sc.SetToolTip(u"Shot number to record per iteration.")

        fgSizer5.Add(self.shotperiter_sc, 0,
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
        ...
        self.m_staticText39.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.m_staticText39.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        ...
        self.waittime_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.waittime_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        fgSizer5.Add(self.waittime_st, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)

        self.waittime_sc = wx.SpinCtrlDouble(
            sbsizer_m.GetStaticBox(),
            wx.ID_ANY,
            value='0.5',
            min=0.1,
            max=100,
        ...
        self.waittime_sc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.waittime_sc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.waittime_sc.SetToolTip(u"Pause time after each iteration setup.")

        fgSizer5.Add(self.waittime_sc, 0,
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
        ...
        self.m_staticText42.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.m_staticText42.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        ...
        self.daqrate_sc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.daqrate_sc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.daqrate_sc.SetToolTip(u"Record to be taken per second.")

        fgSizer5.Add(self.daqrate_sc, 0,
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
        ...
        self.m_staticText43.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.m_staticText43.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        ...
        self.scanfig_panel = funutils.ScanPlotPanel(
            self.m_splitter_l, toolbar=True)
        ...
        self.fit_model_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.fit_model_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        ...
        self.fit_config_ckb = wx.CheckBox(sbSizer13.GetStaticBox(), wx.ID_ANY,
                                          ...
                                          wx.DefaultSize, 0)
        self.fit_config_ckb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.fit_config_ckb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        ...
        self.fit_refresh_btn = wx.BitmapButton(
            sbSizer13.GetStaticBox(), wx.ID_ANY,
            wx.ArtProvider.GetBitmap(u"gtk-refresh", ), wx.DefaultPosition,
            wx.Size(-1, -1), wx.BU_AUTODRAW)
        self.fit_refresh_btn.SetToolTip(u"Refresh fitting curve.")

        bSizer17.Add(self.fit_refresh_btn, 0,
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.fit_to_fig_btn = wx.Button(sbSizer13.GetStaticBox(), wx.ID_ANY,
                                        ...
                                        wx.DefaultSize, 0)
        self.fit_to_fig_btn.SetToolTip(u"Put fitting result to scan figure.")
        ...
        self.lineid_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.lineid_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer2.Add(self.lineid_st,
                     wx.GBPosition(0, 0),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.mark_style_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.mark_style_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer2.Add(self.mark_style_st,
                     wx.GBPosition(1, 0),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.mew_sc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.mew_sc.SetToolTip(u"thickness")

        mksize_hbox.Add(self.mew_sc, 1, wx.ALIGN_CENTER_VERTICAL | wx.ALL
                        | wx.BOTTOM | wx.EXPAND | wx.LEFT | wx.RIGHT | wx.TOP,
                        5)

        gbSizer2.Add(mksize_hbox,
                     wx.GBPosition(1, 1),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 5)
        ...
        self.mec_btn.SetBitmap(wx.Bitmap(k_img))

        self.mec_btn.Bind(wx.EVT_BUTTON, self.mec_btnOnButtonClick)
        self.mec_btn.SetToolTip(u"edgecolor")
        ...
        self.mkstyle_cb.SetToolTip(u"style")

        gbSizer2.Add(self.mkstyle_cb,
                     wx.GBPosition(1, 3),
                     wx.GBSpan(1, 1),
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
        ...
        self.line_style_st.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.line_style_st.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer2.Add(self.line_style_st,
                     wx.GBPosition(2, 0),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.lw_sc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.lw_sc.SetToolTip(u"width")

        lw_hbox.Add(self.lw_sc, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)

        gbSizer2.Add(lw_hbox,
                     wx.GBPosition(2, 1),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 5)
        ...
        self.ls_cb = wx.ComboBox(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                 wx.EmptyString, wx.DefaultPosition,
                                 wx.Size(100, -1), ls_cbChoices, 0)
        self.ls_cb.SetToolTip(u"style")

        gbSizer2.Add(self.ls_cb,
                     wx.GBPosition(2, 3),
                     wx.GBSpan(1, 1),
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
        ...
        self.grid_ckb = wx.CheckBox(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                    ...
                                    wx.DefaultSize, 0)
        self.grid_ckb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.grid_ckb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer2.Add(self.grid_ckb,
                     wx.GBPosition(3, 0),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.legend_ckb = wx.CheckBox(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                      ...
                                      wx.DefaultSize, 0)
        self.legend_ckb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.legend_ckb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer2.Add(self.legend_ckb,
                     wx.GBPosition(3, 1),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.clr_retake_btn = wx.Button(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                        ...
                                        wx.DefaultSize, 0)
        self.clr_retake_btn.SetToolTip(
            u"Clear all picked points for re-scan operation.")

        gbSizer2.Add(self.clr_retake_btn,
                     wx.GBPosition(3, 2),
                     wx.GBSpan(1, 2), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.auto_xlabel_ckb = wx.CheckBox(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                           ...
                                           wx.DefaultSize, 0)
        self.auto_xlabel_ckb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.auto_xlabel_ckb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer2.Add(self.auto_xlabel_ckb,
                     wx.GBPosition(4, 0),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.user_xlabel_ckb = wx.CheckBox(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                           ...
                                           wx.DefaultSize, 0)
        self.user_xlabel_ckb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.user_xlabel_ckb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer2.Add(self.user_xlabel_ckb,
                     wx.GBPosition(4, 1),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.user_xlabel_tc = wx.TextCtrl(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                          wx.EmptyString, wx.DefaultPosition,
                                          wx.DefaultSize, 0)
        self.user_xlabel_tc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.user_xlabel_tc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.user_xlabel_tc.Enable(False)

        gbSizer2.Add(self.user_xlabel_tc,
                     wx.GBPosition(4, 2),
                     wx.GBSpan(1, 2),
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
        ...
        self.auto_title_ckb = wx.CheckBox(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                          ...
                                          wx.DefaultSize, 0)
        self.auto_title_ckb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.auto_title_ckb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer2.Add(self.auto_title_ckb,
                     wx.GBPosition(5, 0),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.user_title_ckb = wx.CheckBox(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                          u"Define", wx.DefaultPosition,
                                          wx.DefaultSize, 0)
        self.user_title_ckb.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.user_title_ckb.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))

        gbSizer2.Add(self.user_title_ckb,
                     wx.GBPosition(5, 1),
                     wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.user_title_tc = wx.TextCtrl(sbSizer14.GetStaticBox(), wx.ID_ANY,
                                         wx.EmptyString, wx.DefaultPosition,
                                         wx.DefaultSize, 0)
        self.user_title_tc.SetFont(
            wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                    wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        self.user_title_tc.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        self.user_title_tc.Enable(False)
        self.user_title_tc.SetToolTip(
            u"Macro: $TITLE could be used to represent the default title string."
        )

        gbSizer2.Add(self.user_title_tc,
                     wx.GBPosition(5, 2),
                     wx.GBSpan(1, 2),
                     wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
        ...
        self.exit_mitem = wx.MenuItem(self.file_menu, wx.ID_EXIT,
                                      u"E&xit" + u"\t" + u"Ctrl+W",
                                      wx.EmptyString, wx.ITEM_NORMAL)
        self.file_menu.Append(self.exit_mitem)
        ...
        self.var1_set_combox.Bind(wx.EVT_COMBOBOX,
                                  self.var1_set_comboxOnCombobox)
...
class FuncListFrame(wx.Frame):
    def __init__(self, parent):
        ...
        self.path_tc.SetToolTip(u"Fullpath of user-defined functions.")
