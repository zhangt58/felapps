...
#------------------------------------------------------------------------#
    ...
    def createMenu(self):
        ...
        ### Exit
        fileMenu = wx.Menu()
        self.importItem = fileMenu.Append(
            wx.ID_ANY, u'&Import Configuration\tCtrl+Shift+I',
            u'Import config file')
        self.exportItem = fileMenu.Append(
            wx.ID_ANY, u'&Export Configuration\tCtrl+Shift+E',
            u'Export config file')
...
#------------------------------------------------------------------------#
    ...
    def createPanel(self):
        ...
        sbox1 = wx.StaticBox(
            self.panel, id=wx.ID_ANY, label=u'Schematic Layout of DCLS')
        ### config staticbox
        ...
        layoutBitmap = wx.StaticBitmap(
            ...
            wx.BitmapFromImage(
                funutils.rescaleImage(resutils.dclslayouticon.GetImage(),
                                      1.0)))
        ...
        sbox2 = wx.StaticBox(
            self.panel, id=wx.ID_ANY, label=u'High-gain Harmonic Generation')
        ### config staticbox
        ...
        moddsBitbtn = wx.BitmapButton(
            self.panel,
            id=wx.ID_ANY,
            bitmap=wx.BitmapFromImage(
                funutils.rescaleImage(resutils.moddsicon.GetImage(), 1.0)))
        radisBitbtn = wx.BitmapButton(
            self.panel,
            id=wx.ID_ANY,
            bitmap=wx.BitmapFromImage(
                funutils.rescaleImage(resutils.radisicon.GetImage(), 1.0)))
        matchBitbtn = wx.BitmapButton(
            self.panel,
            id=wx.ID_ANY,
            bitmap=wx.BitmapFromImage(
                funutils.rescaleImage(resutils.matchicon.GetImage(), 1.0)))
        ...
        self.Bind(
            wx.EVT_BUTTON, self.onModds,
            id=moddsBitbtn.GetId())  # ID_MODDSBBTN)
        self.Bind(
            wx.EVT_BUTTON, self.onMatch,
            id=matchBitbtn.GetId())  # ID_MATCHBBTN)
        self.Bind(
            wx.EVT_BUTTON, self.onRadis,
            id=radisBitbtn.GetId())  # ID_RADISBBTN)

#------------------------------------------------------------------------#

    def onModds(self, event):
        self.moddspanel = felutils.ModdsPanel(
            self,
...
#------------------------------------------------------------------------#
    ...
    def onMatch(self, event):
        self.matchpanel = felutils.MatchPanel(
            self,
...
#------------------------------------------------------------------------#
    ...
    def onRadis(self, event):
        self.radispanel = felutils.RadisPanel(
            self,
