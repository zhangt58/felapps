...
/* Generated from ../O.Common/DCLS.dbd */
...
int DCLS_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/tong/APS/epics/apps/DCLS";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"DCLS_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    DCLS_registerRecordDeviceDriver(*iocshPpdbbase);
}
