...
class ConfigFile(object):
    ...
    def updateConfigs(self, params_dict):
...
class ImageViewer(wx.Frame):
    def __init__(self, parent, size = (930, 700), **kwargs):
        ...
        self.loadConfig(configfilename = 'config.xml')
    ...
    def createPanel(self):
        ...
        self.imgpanel = ImagePanel(self.panel, figsize = (8,8), dpi = 75, bgcolor = self.bkgdcolor)
        ...
        self.imgsrc_tc = wx.TextCtrl(self.panel, value = 'UN-BI:PROF19:ARR',style=wx.TE_PROCESS_ENTER)
...
class AppConfigPanel(wx.Frame):
    ...
    def createPanel(self):
        ...
        gs.Add(self.imgwpxtc,     pos = (0, 1), span = (1, 2), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(item21st,          pos = (1, 0), span = (1, 1), flag = wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(self.imghpxtc,     pos = (1, 1), span = (1, 2), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(item31st,          pos = (2, 0), span = (1, 1), flag = wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(self.pathtc,       pos = (2, 1), span = (1, 2), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(item41st,          pos = (3, 0), span = (1, 1), flag = wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(self.imgnamepretc, pos = (3, 1), span = (1, 2), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(item51st,          pos = (4, 0), span = (1, 1), flag = wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(self.imgnameexttc, pos = (4, 1), span = (1, 2), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(item61st,          pos = (5, 0), span = (1, 1), flag = wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(self.intnamepretc, pos = (5, 1), span = (1, 2), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(item71st,          pos = (6, 0), span = (1, 1), flag = wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(self.intnameexttc, pos = (6, 1), span = (1, 2), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(item81st,          pos = (7, 0), span = (1, 1), flag = wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(self.freqtc,       pos = (7, 1), span = (1, 2), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(item91st,          pos = (8, 0), span = (1, 1), flag = wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(self.bkgdcolortc,  pos = (8, 1), span = (1, 1), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        gs.Add(self.bkgdcolorbtn, pos = (8, 2), span = (1, 1), flag = wx.EXPAND | wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        
        gs.AddGrowableCol(1,2)
        sbsizer.Add(gs, proportion = 0, flag = wx.EXPAND | wx.ALIGN_CENTER | wx.LEFT | wx.RIGHT | wx.TOP, border = 15)
    ...
    def OnUpdateData(self, event):
        ...
        self.parent.configdict['savePath'   ] = self.parent.save_path_str
...
class ShowIntPanel(wx.Frame):
    ...
    def createPanel(self):
        ...
        self.intdisp = ImagePanelxy(self.panel, figsize = (7,5), dpi = 80, bgcolor = self.parent.bkgdcolor)
